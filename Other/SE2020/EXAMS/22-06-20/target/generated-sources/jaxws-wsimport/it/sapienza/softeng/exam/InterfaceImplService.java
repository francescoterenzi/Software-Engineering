 ...
 * 
 */
@WebServiceClient(name = "InterfaceImplService", targetNamespace = "http://exam.softeng.sapienza.it/", wsdlLocation = "http://localhost:8080/Interface?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Interface?wsdl");
